...
def match(dir, icao: str):
    txt = open(dir+'\\output.txt', 'r').read()
    dct = {}
...
def collect_pdf(directory, icao, host, save=True):
    ...
    return True
# collect_pdf(r"C:\Users\sasch\iCloudDrive\Desktop\Projects\Charts\static\pdf_downloads", 'UUEE', host='192.168.1.10')
